...
class benchmarkUI(object):
    def setupUi(self, Form):
        ...
        self.frame.setGeometry(QtCore.QRect(400, 810, 1251, 71))
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 60, 361, 691))
        self.groupBox.setObjectName("groupBox")
        self.layoutWidget1 = QtWidgets.QWidget(self.groupBox)
        self.layoutWidget1.setGeometry(QtCore.QRect(30, 70, 301, 26))
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(30, 160, 301, 151))
        ...
        self.addGaussNoise = QtWidgets.QRadioButton(self.layoutWidget2)
        self.addGaussNoise.setObjectName("addGaussNoise")
        self.verticalLayout.addWidget(self.addGaussNoise)
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.label_9 = QtWidgets.QLabel(self.layoutWidget2)
        self.label_9.setObjectName("label_9")
        self.horizontalLayout_5.addWidget(self.label_9)
        self.sigmaLine = QtWidgets.QLineEdit(self.layoutWidget2)
        self.sigmaLine.setObjectName("sigmaLine")
        self.horizontalLayout_5.addWidget(self.sigmaLine)
        ...
        self.biasLine = QtWidgets.QLineEdit(self.layoutWidget2)
        self.biasLine.setObjectName("biasLine")
        self.horizontalLayout_6.addWidget(self.biasLine)
        self.verticalLayout.addLayout(self.horizontalLayout_6)
        self.loadButton = QtWidgets.QPushButton(self.groupBox)
        self.loadButton.setGeometry(QtCore.QRect(230, 610, 113, 32))
        self.loadButton.setObjectName("loadButton")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.groupBox)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(20, 40, 321, 21))
        self.horizontalLayoutWidget_2.setObjectName("horizontalLayoutWidget_2")
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_2)
        self.horizontalLayout_7.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.dpMethods = QtWidgets.QRadioButton(self.horizontalLayoutWidget_2)
        self.dpMethods.setObjectName("dpMethods")
        self.horizontalLayout_7.addWidget(self.dpMethods)
        self.normMethods = QtWidgets.QRadioButton(self.horizontalLayoutWidget_2)
        self.normMethods.setObjectName("normMethods")
        self.horizontalLayout_7.addWidget(self.normMethods)
        self.label_22 = QtWidgets.QLabel(self.groupBox)
        self.label_22.setGeometry(QtCore.QRect(30, 100, 91, 16))
        self.label_22.setObjectName("label_22")
        self.checkpointSelect = QtWidgets.QToolButton(self.groupBox)
        self.checkpointSelect.setGeometry(QtCore.QRect(300, 120, 31, 22))
        self.checkpointSelect.setObjectName("checkpointSelect")
        self.checkpointLine = QtWidgets.QLineEdit(self.groupBox)
        self.checkpointLine.setGeometry(QtCore.QRect(30, 120, 261, 21))
        self.checkpointLine.setObjectName("checkpointLine")
        self.listView = QtWidgets.QListView(self.groupBox)
        self.listView.setGeometry(QtCore.QRect(30, 320, 301, 271))
    ...
    def retranslateUi(self, Form):
        ...
        self.moveButton.setText(_translate("Form", "Next"))
        ...
        self.addGaussNoise.setText(_translate("Form", "Gauss Noise"))
        self.label_9.setText(_translate("Form", "sigma:"))
        self.label_21.setText(_translate("Form", "bias:"))
        self.loadButton.setText(_translate("Form", "Load"))
        self.dpMethods.setText(_translate("Form", "Deep Learning Methods"))
        self.normMethods.setText(_translate("Form", "Normal Methods"))
        self.label_22.setText(_translate("Form", "Checkpoint:"))
        self.checkpointSelect.setText(_translate("Form", "..."))
